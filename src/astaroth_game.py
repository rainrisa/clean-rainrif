...
class AstarothGame():
  ...
  def set_players(self, message: Message):
    ...
    for entity in message.entities:
      if entity.type == MessageEntityType.TEXT_MENTION:
        ...
        player = Player(user_name, entity.user.id)
  ...
  async def send_live_rank_message(self):
    if self.live_rank_message_id:
      ...
      if not graveyard_config.live_rank: return
  ...
  def get_live_text(self):
    ...
    text = f"**{graveyard_config.astaroth_live_title}**"
